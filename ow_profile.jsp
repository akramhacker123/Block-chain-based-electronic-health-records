        ...
        <div class="article">
          ...
          <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						try 
						{
						   	String query="select * from Hospital where name='"+user+"'"; 
            ...
            <tr>
              <td  width="145" height="40" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5 style3" style="margin-left:20px;"><strong>Hospital Name </strong></div></td>
