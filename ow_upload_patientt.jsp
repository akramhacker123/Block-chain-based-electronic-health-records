      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="598" border="1" align="center" cellspacing="0" cellpadding="10">
			...
			<tr>
              <td width="286" bgcolor="#FF0000"><div align="center" class="style4"><span class="style10 style11 style12 style3">Select Report :- </span></div></td>
              <td width="356"><input name="t42" type="file" id="file"  onchange="loadFileAsText()" required="required" /></td>
            </tr>
            <tr>
              <td bgcolor="#FF0000" class="style4 style10 style11 style12"><div align="center" class="style4"><span class="style10 style11 style12 style3">Report</span> Name :- </div></td>
            ...
            <tr>
              <td bgcolor="#FF0000"><span class="style4">Enter Blood Pressure </span></td>
