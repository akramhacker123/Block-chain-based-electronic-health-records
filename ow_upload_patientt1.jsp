      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="598" border="1" align="center" cellspacing="0" cellpadding="10">
            ...
            <tr>
              <td bgcolor="#FF0000" class="style4 style10 style11 style12"><div align="center" class="style4">Report  Name :- </div></td>
              <td><input name="tt" type="text" id="tt"  value="<%=file%>" size="50"/></td>
              </tr>
			  
            
            <tr>
              <td bgcolor="#FF0000"><div align="center" class="style3 style4"><strong>Report Content :- </strong></div></td>
			  <td><textarea name="text" cols="50" rows="15" readonly><%= cont %></textarea></td>
            </tr>
			
			  <tr>
              <td bgcolor="#FF0000" class="style4 style10 style11 style12"><div align="center" class="style4">Blood Pressure  :- </div></td>
              <td><input name="bp" type="text" id="tt"  value="<%=bp%>" size="50"/></td>
              </tr>
			
			<tr>
		<td bgcolor="#FF0000"><div align="center" class="style3 style9"><strong><span class="style8 style10 style11">Select Diagnose Image:- </span></strong></div></td>
