...
<body>
  ...
  <tr>
	...
	<td width="81" bgcolor="#FF0000"><div align="center" class="style2 style6"><strong>BP</strong></div></td>
	<td width="58" bgcolor="#FF0000"><div align="center" class="style2 style6"><strong>Patient File </strong></div></td>
  </tr>

	<%
		String s1 = "", s2 = "", s3 = "", s4 = "", s5 = "", s6 = "", s7 = "", s8, s9 = "", s10, s11, s12, s13,s14,s15,s16,s17,s20;
		int i = 0, j = 0, k = 0;
