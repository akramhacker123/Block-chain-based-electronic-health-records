...
<%
		  ...
		  PreparedStatement ps=connection.prepareStatement("insert into patient_details (pname,paddress,dob,email,mobile,age,hospital,disease,bg,sym,fname,cont,image,dt,owname,sk,down_rank,search_rank,bp,hcode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
