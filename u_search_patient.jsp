...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Search Secure similarity queries by Keyword </h2>
          <p align="center">&nbsp;</p>
                    ...
                    <TR>
                      <TD width="174" bgcolor="#FFFF00"><div align="center" class="header">
                        <div align="right" class="style12">
                          <div align="center" class="style3">Enter  Keyword</div>
                        </div>
                      </div></TD>
                      <TD width="152">
...
<p>&nbsp;</p>
<p class="style7">Secure Similarity Queries Response Details..  </p>
<p>
								...
								while(rs2.next())
										{
										   ...
										   s5 = rs2.getString(13);//enc_cont
						                        ...
						                        String decryptedValues3 = new String(Base64.decode(s3.getBytes()));//dis
												String decryptedValues5 = new String(Base64.decode(s5.getBytes()));//cont
												String ds4 = new String(Base64.decode(s4.getBytes())).toLowerCase();//fn
									   
					
										if ((decryptedValues3.toLowerCase().contains(keyword)) || (decryptedValues5.toLowerCase().contains(keyword)) || (s2.contains(keyword)) )
										{
...
<p> 
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="u_main.jsp"><span>Client Main</span></a></li>
